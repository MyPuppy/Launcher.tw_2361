...
namespace KartRider
{
    public class FlyingPet
    {
        ...
        public static void FlyingPet_Spec()
        {
            ...
            else if (StartGameData.FlyingPet_id == 20 || StartGameData.FlyingPet_id == 21 || StartGameData.FlyingPet_id == 22 || StartGameData.FlyingPet_id == 23 || StartGameData.FlyingPet_id == 24)
            {
                FlyingPet.DragFactor = -0.0008f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
                FlyingPet.CornerDrawFactor = 0f;
                FlyingPet.NormalBoosterTime = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 55)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 70)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
